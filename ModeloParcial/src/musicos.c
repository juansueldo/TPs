...
eMusico eMusico_CargarDatos(void) {
	...
	if((utn_getString(auxiliar.apellido,MAX_CHARS_CADENAS,"INGRESE APELLIDO: ","ERROR. REINGRESE: ",3,3)) != 0)
	{
			printf("\n Error al ingresar el nombre");
	}
	if(utn_getNumero(&auxiliar.edad,"INGRESE DIA: ", "ERROR. REINGRESE: ",1,31,3) != 0)
	{
